...
public class Device {
    ...
    public final String name; // ro.io.device
    public final int date;    // ro.io.date
    public final String userAgent;

    private Device() {
        name = SystemProperties.get("ro.io.device", UNKNOWN);
        date = SystemProperties.getInt("ro.io.date", -1);
        userAgent = String.format("%s/%s", "org.io.ota", name);
    }
